...
export default class CreateAudio extends React.Component {
    ...
    onFinish = values =>{
        ...
        https.fetchPost("/material/sound/upload", formDatas)
        .then(data => {
            this.setState({ isDisable: false });
            if (data.code == 200) {
    ...
    render() {
        ...
        return (
            <Card title="新建音频" bordered={false}>
                ...
                >
                    ...
                    <div className="formGroup">
                        ...
                        >
                            ...
                            <input type="file" id="media" accept=".mp3" onChange={this.fileChange} hidden />
                        </div>
